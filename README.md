...
[🎥 **시연 영상**](https://youtu.be/wrxArsUJg5k) • [📊 **발표자료**](https://github.com/user-attachments/files/21451998/02._4.pdf)
...
<table align="center">
  <tr>
    ...
    <td align="center" style="padding: 20px; border: 1px solid #ddd;">
      <img src="https://github.com/user-attachments/assets/1052d0df-d0bb-45c3-94f7-ab9bda678ed0" width="180px;" height="220px;" style="object-fit: cover; border-radius: 8px;" alt="최윤하"/>
      <br /><br />
      <h3><b>최윤하</b></h3>
      <p><b>👑 팀장</b></p>
      <hr style="width: 80%; margin: 10px auto;">
      <p>📧 <code>choiyunha531@gmail.com</code></p>
      <ul style="text-align: left; list-style: none; padding-left: 0;">
        <li>• AWS 3-tier 구축</li>
        <li>• GCP CDN, Armor</li>
        <li>• VPN 터널링</li>
